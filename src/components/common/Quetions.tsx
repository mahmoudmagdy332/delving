...
export default function Quetions() {
  ...
  return (
    <div className='flex flex-col gap-5'>
      <Accordion sx={{bgcolor:'transparent'}} className='rounded-xl' expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <AccordionSummary   id="panel1d-header">
          <Typography className='rounded-2xl'>Can I test the program before applying?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
