  ...
  return (
    <div className="flex flex-col items-center mb-20 w-10/12 lg:w-3/4 mx-auto mt-10">
      ...
      <div className="flex flex-col md:flex-row  items-center ">
        <div className="flex flex-col gap-6 lg:w-1/3 md:w-2/5">
          {levels.map((level, index) => (
            <div
              key={index}
              className={`flex items-center gap-4 p-4 rounded-lg cursor-pointer  hover:bg-[#f7f7f8] ${
        ...
        <div
          className=" relative p-10 border-2 rounded-3xl  border-black lg:w-1/3 h-[75vh] md:w-2/5"
        ...
        <div className="flex flex-col gap-6  md:w-1/5 lg:w-1/3 p-5 ">
