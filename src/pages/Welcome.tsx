    ...
    <div className="my-20 w-10/12 lg:w-3/4 xl:w-1/2 mx-auto flex flex-col gap-2 items-center">
        ...
        <div className="flex items-center">
         ...
         <div className="flex flex-col gap-4 justify-center w-full">
            <Box sx={{borderColor:'black.light',}}className="border w-full rounded-lg  py-4 px-4 flex gap-4 items-center">
            ...
            <Button sx={{bgcolor:'primary.main',fontSize:'16px',"&:hover":{bgcolor:'black.dark'},color:'background.default',fontWeight:'600',px:'30px',py:"15px",borderRadius:'7px',mt:"20px"}} >Continue </Button>
